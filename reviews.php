							...
							<div class="col">
								<div id="rw-3-1" class="review-3 bg--stone">
									...
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Quaerat sodales sapien euismod blandit aliquet ipsum primis ociis cubilia laoreet 
											augue integer aliquam dolor luctus egestas sapien and vitae aliquet lorem purus
										</p>
							...
							<div class="col">
								<div id="rw-3-2" class="review-3 bg--stone">
									...
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Sagittis congue augue magna ipsum vitae purus ipsum primis cubilia laoreet augue 
											vitae egestas luctus donec ultrice ligula and magna suscipit lectus gestas an augue
											gravida aliquet ipsum ultrices justo suscipit mauris	   
										</p>
							...
							<div class="col">
								<div id="rw-3-3" class="review-3 bg--stone">
									...
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Nemo ipsam egestas volute turpis ociis ipsum egestas purus sapien ultrice and 
											aliquam ipsum quaerat augue dolor turpis sapien cursus magna mollis congue purus 
											quaerat ligula purus egestas magna cursus molestie
										</p>
							...
							<div class="col">
								<div id="rw-3-4" class="review-3 bg--stone">
									...
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Augue at vitae purus tempus egestas an augue volutpat cubilia laoreet magna suscipit 
											ipsum luctus dolor purus blandit and tempus feugiat impedit sagittis lacinia
										</p>
					...
					<div class="row justify-content-center">	
						<div class="col-lg-10 col-xl-8">
							<div class="section-title">
								<h3 class="h3-lg color--black">Follow: <a href="#">@Angel Zaneta_studio</a></h3>	
							</div>	
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="bottom-footer">
						<div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
							...
							<!-- FOOTER COPYRIGHT -->
							<div class="col">
								<div class="footer-copyright"><p>&copy; 2023 Angel Zaneta. All Rights Reserved</p></div>
							</div>
...
<!-- Mirrored from dsathemes.com/html/r_eine_1.1/files/reviews.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Dec 2023 17:25:54 GMT -->
</html>